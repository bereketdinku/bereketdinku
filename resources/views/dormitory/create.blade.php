<div class="modal fade" id="staticBackdrop" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <form name="new_branch" method="post" action="{{ route('dormitory.store') }}">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">New Dormitory </h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label for="code" class="col-2 col-form-label">Collages</label>
                            <div class="col-10">
                                <select class="form-control select2" name="collage_id">
