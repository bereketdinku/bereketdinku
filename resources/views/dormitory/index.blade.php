            ...
            <div class="col-md-12">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Dormitory
                            <span class="d-block text-muted pt-2 font-size-sm">All Dormitories</span>
                        </h3>
                    </div>
                    <div class="card-toolbar justify-content-left ">
         <form class="form-inline my-2 my-lg-0"type="get"action="{{url('/searchDO')}}">
                    ...
                    <table class="table">
                        ...
                        @foreach ($dormitories as $dormitory)
                            ...
                            <tr>
                               ...
                               <form action="{{route('dormitory.destroy',$dormitory->id)}}"method="post">
<a href="{{url('dormitory/edit',$dormitory->id)}}"class="btn btn-primary">Edit</a>
