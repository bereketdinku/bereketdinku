...
<div class="modal fade" id="staticBackdrop" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <form name="new_branch" method="post" action="{{ route('asses.store') }}">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-2 col-form-label"> Teacher Name</label>
                            <div class="col-10">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-2 col-form-label"> mark</label>
                            <div class="col-10">
                                <input class="form-control" name="mark" type="text" value="" id="name"/>
                            </div>
                        <div class="form-group row">
