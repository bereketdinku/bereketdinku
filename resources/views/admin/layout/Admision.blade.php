					...
					<div class="col-sm-12">
						...
						<input type="text" name="mother_phone"placeholder="Enter  Mother phone Here.." class="form-control">
							...
							<div class="col-sm-4 form-group">
								...
								<input type="date" name="dob" placeholder="Enter Last Name Here.." class="form-control">
							</div>
						</div>
							<div class="row">
							<div class="col-sm-4 form-group">
            			...
            			<div class="col-sm-4 form-group">
								...
								<input type="date"name="dor" placeholder="Enter date of register Here.." class="form-control">
							</div>
							<div class="col-sm-4 form-group">
						<legend> Phone</legend>
