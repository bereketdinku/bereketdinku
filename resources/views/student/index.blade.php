            ...
            <div class="col-md-12">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">
                            Registered Student
                            <span class="d-block text-muted pt-2 font-size-sm">All Registered Student</span>
                        </h3>
                    </div>
                        ...
                        @foreach ($academic_years as $academic_year)
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ $academic_year->first }} 
                                <td>
                                    {{ $academic_year->middle }} 
                                </td>
                                <td>
                                   {{ $academic_year->faculity }} 
                                </td>
                                <td>{{$academic_year->department}}</td>
                                  <td> 
                                     <form action="{{route('academic-year.destroy',$academic_year->id)}}"method="post">

                                       <a href="{{url('academic_year/edit',$academic_year->id)}}" class="btn btn-primary">Edit</a>  
